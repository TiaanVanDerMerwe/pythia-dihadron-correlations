...
def read_and_combine_bins(filenames, trig_pt_min=TRIG_PT_MIN, trig_pt_max=TRIG_PT_MAX,
    ...
    for idx, fname in enumerate(filenames):
        ...
        assoc_mask = (data['assoc_pT'] / data['trigger_pT']   > zt_min) & (data['assoc_pT'] / data['trigger_pT']  <= zt_max)
...
def save_projections_to_csv(
    ...
    header_lines = [
        ...
        f'# dNpair_dDeltaPhi   : 1/Ntrig x dNpair/dΔφ  (ZYAM-subtracted)',
    ...
    deta_header = [
        ...
        f'# dNpair_dDeltaEta : 1/Ntrig x dNpair/dΔη',
    ]
...
def plot_correlation_with_projections(correlation, eta_centers, phi_centers,
    ...
    if exp_data_loaded and exp_phi is not None:
        ...
        ax_rat.text(0.5, 0.5, 'STAR data not loaded',
                    ha='center', va='center',
                    transform=ax_rat.transAxes, fontsize=9, color='gray')
...
def main():
    POW  = 3
    BASE = f'pythiaData/2760/test/fsr'
    ...
    out_dir = f'plots/correlations/test/fsr'
