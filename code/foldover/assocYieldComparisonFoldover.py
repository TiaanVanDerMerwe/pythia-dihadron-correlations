...
# ── file locations ────────────────────────────────────────────────────────────
FILENAME = "integrated_yields_trig19-24.csv"
CONFIGS = ["default", "nofsr"]
...
TRIG_PT = (19.2, 24.0)
SAVE_PATH = "yield_comparison_trig19.2-24.0.png"
...
fig, axes = plt.subplots(
    ...
    gridspec_kw={"height_ratios": height_ratios, "hspace": 0.20, "wspace": 0.30},
)
    ...
    for col, side in enumerate(sides):
        ...
        with np.errstate(divide="ignore", invalid="ignore"):
            ...
            ratio_err = np.where(
                y_var_interp != 0,
                ratio
                * np.sqrt((e_def / y_def) ** 2 + (e_var_interp / y_var_interp) ** 2),
                np.nan,
            )
